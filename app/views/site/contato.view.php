		...
		<div class="capa">
			...
			<div class="form-background">
				<form action="enviaEmail" method="POST" class="card">
					...
					</svg> contato@codejr.com.br</p>
					
					<h3>Telefone:</h3>
					<p><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-telephone-forward-fill" viewBox="0 0 16 16">
					...
					<a class="icon" href= "https://www.instagram.com/codejr" target="_blank"><i class="social-icons bi bi-instagram"></i></a>
					<a class="icon" href= "https://www.linkedin.com/company/code-empresa-j%C3%BAnior/" target="_blank"> <i class="social-icons bi bi-linkedin"></i></a>
					<a class="icon" href="https://github.com/isa56/traineeCode-AdoraLer" target="_blank"><i class="social-icons bi bi-github"></i></a>
					...
					</svg></i> Rua José Lourenço Kelmer, UFJF,<br>Instituto de Ciências Exatas, sala 3313</p>
					<br><br>
					</div>
