...
<body>
    ...
    <div class="container">
        ...
        <form method="POST" action="updateAction" id="badform">
            <?php foreach ($produto as $prod) : ?>
                ...
                <div class="produto-details">
                    <div class="input-box">
                        ...
                        <input type="text" placeholder="Escreva o nome do produto" name="nome" value="<?= $prod->nome ?>">
                    ...
                    <div class="input-box">
                        ...
                        <input type="text" placeholder="Digite novo preco" name="preco" value="<?= $prod->preco ?>">
                    </div>
                    <div class="input-box">
                        <span class="details">descricao</span>
                        <input type="text" placeholder="Digite a nova descricao" name="descricao" value="<?= $prod->descricao ?>">
                    </div>
                    <div class="input-box">
                        <span class="details">info uteis</span>
                        <input type="text" placeholder="Digite nova info util" name="info_util" value="<?= $prod->info_uteis ?>">
                    </div>
                </div>
                <div class="button">
                    <input type="hidden" value="<?= $prod->id ?>" id="envia" name="id">
